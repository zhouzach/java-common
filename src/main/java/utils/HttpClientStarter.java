...
public class HttpClientStarter {
    ...
    private OkHttpClient buildeClient(long connectTimeout, long readTimeout, long writeTimeout) {
    ...
    public String post(String url, RequestBody body, long connectTimeout, long readTimeout, long writeTimeout) {
    ...
    public static void main(String[] args) {
        ...
        String response = starter.post(postUrl, body);
        ...
        String response1 = starter.post(url, formBody);
